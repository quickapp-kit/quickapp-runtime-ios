...
shasum -a 256 "${BUILD_DIR}/quickapp_ios_simulator.app/inspection-board.rpk"
shasum -a 256 "${BUILD_DIR}/quickapp_ios_simulator.app/content-hub.rpk"
shasum -a 256 "${BUILD_DIR}/quickapp_ios_simulator.app/health-summary.rpk"
